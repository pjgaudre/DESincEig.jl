...
=#
function SincEigen{T<:Number,S<:Integer}(q::Function,ρ::Function,domain::Domain{T},β::Vector{T},γ::Vector{T},dopt::T; enum::Tuple{S,Any}=(0,NaN), tol::T=5e-12, Range::Vector{S}=collect(1:1:100), u0::T=one(T), u::Vector{T}=[zero(T)], Trace_Mesh::Bool=false,Centro::Bool=false)
